...
**Naming:** Use descriptive names, e.g. `masters_<field>_2025.pdf`, `bachelors_<field>_2016.pdf`. Naming does not affect parsing.
...
**Naming:** Use the referee's name, e.g. `reference_<referee_name>.pdf`.
