...
The tool reads a `salary_data.json` file in the repo root containing company salary benchmarks. It uses fuzzy matching to find companies by name, handling accented characters, common legal suffixes, and spelling variations.
...
```json
{
  "metadata": {
    ...
    "index_baseline": 0,
    "index_label": "Monthly salary (USD)",
...
python salary_lookup.py "Globex" --city "Example City"
...
- The fuzzy matcher handles common company-name variations: legal suffixes, accented characters, anglicized spellings, and partial matches.
