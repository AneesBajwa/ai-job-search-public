...
- **Job portals:** "Search runs across mainstream job boards (hiring.cafe, LinkedIn, Indeed, Glassdoor, Wellfound, BuiltIn, We Work Remotely). Add a national board for your country if you'd like (e.g. Job Bank Canada, USAJOBS). Are these right, or do you want to add or remove any?" Confirm the user's work-arrangement preference (remote/hybrid/on-site), any company-stage preference, and the recency window.
