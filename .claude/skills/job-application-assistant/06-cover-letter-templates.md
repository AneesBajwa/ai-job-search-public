...
%     TITLE NAME
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{}{\Huge{[Your Name]}}{  \href{mailto:your.email@example.com}{your.email@example.com} | [phone] |  \urlstyle{same}\href{https://linkedin.com/in/your-handle}{LinkedIn}
}
...
### Language
- All cover letters are written in English. Use "Kind regards," or "Sincerely," for the closing.
