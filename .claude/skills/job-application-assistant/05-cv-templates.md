...
**Profile statement templates** — write one per role type you target (tailor the specifics to each posting). Each is 2-3 sentences: your seniority + core stack, the kind of impact you deliver, and one or two standout, verifiable achievements. Examples of the shape:

**For [your primary role type, e.g. Senior Full-Stack]:**
> [Seniority] [role] with [X]+ years shipping [what] across [your core stack]. [What you build, end-to-end]. Recently delivered [one or two standout, verifiable achievements] at [company].

**For [a second role type you target]:**
> [Specialist framing emphasizing the skills that role cares about, backed by a concrete, measurable result.]

**For [a third role type]:**
> [Framing for that role type, with a verifiable achievement.]
